...
setup(
    ...
    packages=[
        ...
        'sonic_platform_base.sonic_xcvr.api.remote-upgrade',
        'sonic_platform_base.sonic_xcvr.mem_maps.remote-upgrade',
        'sonic_platform_base.sonic_xcvr.codes.remote-upgrade',
        'sonic_psu',
        'sonic_sfp',
        'sonic_thermal',
        'sonic_y_cable',
